...
import class_1 from '../../assets/img/class-1.jpg';
import class_2 from '../../assets/img/class-2.jpg';
import class_3 from '../../assets/img/class-3.jpg';
        ...
        <div className="row">
          <div className="col-lg-4 mb-5">
            <div className="card border-0 bg-light shadow-sm pb-2">
              <img className="card-img-top mb-2" src={class_1} alt="" />
              <div className="card-body text-center">
                <h4 className="card-title">Drawing Class</h4>
                <p className="card-text">help your kids to learn Drawing</p>
              </div>
              <div className="card-footer bg-transparent py-4 px-5">
                ...
                <div className="row">
                  ...
                  <div className="col-6 py-1">$100/ Month</div>
                </div>
              </div>
              <Link to="/ContractPage" className="btn px-3 mx-auto mb-4 btn-sm">contract now</Link>
            </div>
          </div>
          <div className="col-lg-4 mb-5">
            <div className="card border-0 bg-light shadow-sm pb-2">
              <img className="card-img-top mb-2" src={class_2} alt="" />
              <div className="card-body text-center">
                <h4 className="card-title">Language Learning</h4>
                <p className="card-text">we help your kids to learn languages</p>
              </div>
              <div className="card-footer bg-transparent py-4 px-5">
                <div className="row border-bottom">
                  <div className="col-6 py-1 text-right border-right"><strong>Age of Kids</strong></div>
                ...
                <div className="row">
                  <div className="col-6 py-1 text-right border-right"><strong>Tution Fee</strong></div>
                  <div className="col-6 py-1">$200 / Month</div>
                </div>
              </div>
              <Link to="/ContractPage" className="btn px-3 mx-auto mb-4 btn-sm">contract now</Link>
            </div>
          ...
          <div className="col-lg-4 mb-5">
            <div className="card border-0 bg-light shadow-sm pb-2">
              <img className="card-img-top mb-2" src={class_3} alt="" />
              <div className="card-body text-center">
                <h4 className="card-title">Basic Science</h4>
                <p className="card-text">we help your kids to Basic Science</p>
              </div>
              <div className="card-footer bg-transparent py-4 px-5">
                <div className="row border-bottom">
                  <div className="col-6 py-1 text-right border-right"><strong>Age of Kids</strong></div>
                ...
                <div className="row">
                  <div className="col-6 py-1 text-right border-right"><strong>Tution Fee</strong></div>
                  <div className="col-6 py-1">$300 / Month</div>
                </div>
              </div>
              <Link to="/ContractPage" className="btn px-3 mx-auto mb-4 btn-sm">contract now</Link>
            </div>
